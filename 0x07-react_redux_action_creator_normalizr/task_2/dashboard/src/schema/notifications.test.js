...
import { normalizedNotification, Ade } from './notifications';
...
describe('Normalized data', () => {
  // const normalizedData = normalizedNotification;
  const normalizedData = normalizedNotification;

  it('Result array contains correct ids', () => {
    const expectedIds = [
  ...
  it('Users entity contains correct user', () => {
    const userId = '5debd764a7c57c7839d722e9';
  ...
  it('Messages entity contains correct message', () => {
  ...
  test('Notifications entity contains correct notification', () => {
